...
<html>
  ...
  <body>
    ...
    <div class=example>
      ...
      <div id=timer-static>"   (prum/render-html (timer-static/timer-static "Static" @core/*clock)) "</div>
      <div id=timer-reactive>" (prum/render-html (timer-reactive/timer-reactive)) "</div>
    </div>

    <div class=example>
      <div class=example-title>Controls</div>
      <div id=controls>" (prum/render-html (controls/controls)) "</div>
    </div>

    <div class=example>
      <div class=example-title>Reactive binary clock</div>
      <div id=binary-clock>" (prum/render-html (binary-clock/binary-clock)) "</div>
    </div>

    <div class=example>
      <div class=example-title>Reactive artboard</div>
      <div id=board-reactive>" (prum/render-html (board-reactive/board-reactive)) "</div>
    </div>

    <div class=example>
      <div class=example-title>BMI Calculator</div>
      <div id=bmi-calculator>" (prum/render-html (bmi-calculator/bmi-calculator)) "</div>
    </div>
    ...
    <div class=example>
      ...
      <div id=inputs>" (prum/render-html (inputs/inputs)) "</div>
    </div>

    <div class=example>
      <div class=example-title>Local state</div>
      <div id=local-state>" (prum/render-html (local-state/local-state "Clicks count")) "</div>
    </div>

    <div class=example>
      <div class=example-title>Keys</div>
      <div id=keys>" (prum/render-html (keys/keys)) "</div>
    </div>

    <div class=example>
      <div class=example-title>Self-reference</div>
      <div id=self-reference>" (prum/render-html (self-reference/self-reference [:a [:b [:c :d [:e] :g]]])) "</div>
    </div>
